...
function functionalQuizzes (nextBtn, counterCorrectAnswer, counterWrongAnswer) {
    nextBtn.addEventListener("click", function () {
        ...
        if (counterCorrectAnswer + counterWrongAnswer === nextBtn.parentElement.parentElement.querySelectorAll(".quiz__question").length) {
            document.querySelector(".quiz-statistics__correct").textContent = "Правильных ответов: " + counterCorrectAnswer;
            document.querySelector(".quiz-statistics__wrong").textContent = "Неправильных ответов: " + counterWrongAnswer;
